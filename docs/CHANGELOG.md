...
- Added full Pydantic models for all OpenAPI component types with complete spec compliance including Schema, Parameter, Response, RequestBody, Example, SecurityScheme, Header, MediaType, Link, Callback, and OAuthFlows.
