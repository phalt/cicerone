...
from cicerone.spec import encoding
...
class MediaType(pydantic.BaseModel):
    ...
    encoding: "dict[str, encoding.Encoding]" = pydantic.Field(default_factory=dict)
    ...
    def from_dict(cls, data: dict[str, typing.Any]) -> MediaType:
        ...
        return cls(
            ...
            encoding=model_utils.parse_collection(data, "encoding", encoding.Encoding.from_dict),
