...
- Added full Pydantic models for all OpenAPI component types with complete spec compliance including Parameter, Response, RequestBody, Example, SecurityScheme, Header, MediaType, Link, Callback, and OAuthFlows.
- Schema objects are now properly typed throughout (Parameter.schema, Header.schema, Response.schema use Schema instead of Any).
